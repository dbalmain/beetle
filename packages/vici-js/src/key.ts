// Vi key notation. Behaviour matches `/home/dave/w/vici/crates/vici/src/key.rs`.
// Types come from `@beetle/contract`; this module is parse / render / construct.

import type { Key, KeyCode } from "@beetle/contract";
